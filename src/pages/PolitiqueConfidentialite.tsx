            ...
            <div className="space-y-8">
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50 text-white">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white mb-2">Données Collectées</h2>
                    <div className="h-1 w-16 bg-gradient-to-r from-primary to-transparent rounded-full" />
                  </div>
                </div>
                
                <div className="space-y-4 text-zinc-300">
                    <p><strong className="text-white">Informations d'identification :</strong></p>
                  ...
                  <p className="pt-4"><strong className="text-white">Données relatives à votre contenu :</strong></p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <p className="pt-4"><strong className="text-white">Données techniques :</strong></p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>Adresse IP</li>
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50 text-white">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white mb-2">Utilisation des Données</h2>
                    <div className="h-1 w-16 bg-gradient-to-r from-primary to-transparent rounded-full" />
                  </div>
                </div>
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50 text-white">
                ...
                <div className="space-y-4 text-zinc-300">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong className="text-white">Prestataires de services :</strong> Partenaires techniques nécessaires à la fourniture de nos services (hébergement, paiement, etc.)</li>
                    <li><strong className="text-white">Obligations légales :</strong> Si la loi l'exige ou pour protéger nos droits légaux</li>
                    <li><strong className="text-white">Partenaires juridiques :</strong> Avocats et experts légaux dans le cadre d'actions juridiques</li>
                  </ul>
                  <p className="pt-4">
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50 text-white">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white mb-2">Sécurité des Données</h2>
                    <div className="h-1 w-16 bg-gradient-to-r from-primary to-transparent rounded-full" />
                  </div>
                </div>
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50 text-white">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-white mb-2">Vos Droits (RGPD)</h2>
                    <div className="h-1 w-16 bg-gradient-to-r from-primary to-transparent rounded-full" />
                  </div>
                </div>
                ...
                <div className="space-y-4 text-zinc-300">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong className="text-white">Droit d'accès :</strong> Consulter les données que nous détenons sur vous</li>
              ...
              {/* Conservation */}
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50 text-white">
                <h2 className="text-2xl font-bold text-white mb-6">Conservation des Données</h2>
                <div className="space-y-4 text-zinc-300">
                  <p>
              ...
              {/* Contact */}
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50 text-white">
                <h2 className="text-2xl font-bold text-white mb-6">Contact DPO</h2>
                <div className="space-y-4 text-zinc-300">
