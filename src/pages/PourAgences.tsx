...
const PourAgences = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white antialiased">
      ...
      {/* SECTION 10 - Systems Highlights Banner */}
        ...
        <div className="container mx-auto max-w-7xl">
          <motion.div
            ...
            style={{
              ...
              WebkitBackdropFilter: 'blur(30px) saturate(180%)',
              border: '1px solid rgba(59, 130, 246, 0.3)',
              boxShadow: '0 20px 60px 0 rgba(59, 130, 246, 0.2), inset 0 0 100px rgba(59, 130, 246, 0.1)',
            }}
          >
            <div className="relative z-10">
              <div className="text-center mb-10">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">
                  Nos systèmes en action
                </h2>
                <p className="text-lg text-zinc-300 max-w-2xl mx-auto">
                  Une suite complète d'outils pensés pour les agences
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description: "Tous vos créateurs, toutes vos données, un seul endroit"
                  },
                  {
                    icon: Shield,
                    title: "Protection automatisée",
                    description: "Détection, suppression et suivi en temps réel"
                  },
                  {
                    icon: Scale,
                    title: "Escalades juridiques",
                    description: "Pour les cas complexes, via partenaires spécialisés"
                  },
                  {
                    icon: FileText,
                    title: "Rapports professionnels",
                    description: "PDF prêts à partager avec vos clients"
                  }
                ].map((system, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800/50 hover:border-blue-500/50 transition-all duration-300 hover:bg-zinc-900/70"
                    >
      ...
      {/* SECTION 11 - Interactive Showcase */}
