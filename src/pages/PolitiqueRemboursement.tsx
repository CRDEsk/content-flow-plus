            ...
            <div className="space-y-8">
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-foreground mb-2">Principe Général</h2>
                ...
                <div className="space-y-4 text-zinc-300">
                  ...
                  <p>
                    <strong className="text-foreground">Important :</strong> Compte tenu de la nature de nos services (détection et suppression de contenus), les demandes de remboursement sont évaluées au cas par cas.
                  </p>
                </div>
              </section>
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-foreground mb-2">Cas de Remboursement Acceptés</h2>
                ...
                <div className="space-y-4 text-zinc-300">
                  ...
                  <div className="space-y-6 pt-4">
                    <div className="pl-4 border-l-2 border-green-500/30">
                      <h3 className="text-lg font-semibold text-foreground mb-2">1. Problème technique majeur</h3>
                    ...
                    <div className="pl-4 border-l-2 border-green-500/30">
                      <h3 className="text-lg font-semibold text-foreground mb-2">2. Non-prestation du service</h3>
                      <p>Si nous n'avons fourni aucun service après un délai de 7 jours suivant votre souscription et paiement.</p>
                    </div>
                    
                    <div className="pl-4 border-l-2 border-green-500/30">
                      <h3 className="text-lg font-semibold text-foreground mb-2">3. Erreur de facturation</h3>
                      <p>En cas de double facturation ou d'erreur manifeste dans le montant facturé.</p>
                    </div>
                    
                    <div className="pl-4 border-l-2 border-green-500/30">
                      <h3 className="text-lg font-semibold text-foreground mb-2">4. Annulation dans les 48h (sous conditions)</h3>
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-foreground mb-2">Cas de Remboursement Refusés</h2>
                ...
                <div className="space-y-4 text-zinc-300">
                  ...
                  <ul className="list-disc list-inside space-y-3 ml-4 pt-4">
                    <li>
                      <strong className="text-foreground">Résultats insatisfaisants :</strong> Si des actions ont été entreprises mais que certaines plateformes n'ont pas supprimé le contenu (obligation de moyens, pas de résultat garanti)
                    </li>
                    <li>
                      <strong className="text-foreground">Changement d'avis :</strong> Après avoir utilisé les services (scans effectués, rapports générés, actions lancées)
                    </li>
                    <li>
                      <strong className="text-foreground">Non-respect des CGV :</strong> Si le client a fourni de fausses informations ou utilisé le service de manière abusive
                    </li>
                    <li>
                      <strong className="text-foreground">Résiliation anticipée :</strong> Aucun remboursement au prorata pour les périodes non utilisées en cas de résiliation avant la fin de l'abonnement
                    </li>
                    <li>
                      <strong className="text-foreground">Services partiellement utilisés :</strong> Si des scans ont été réalisés et que des actions sont en cours
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-foreground mb-2">Procédure de Demande</h2>
                    <div className="h-1 w-16 bg-gradient-to-r from-primary to-transparent rounded-full" />
                  </div>
                </div>
                
                <div className="space-y-4 text-zinc-300">
                  <p><strong className="text-foreground">Pour demander un remboursement :</strong></p>
                  
                  <ol className="list-decimal list-inside space-y-3 ml-4 pt-4">
                    <li>
                      <strong className="text-foreground">Contactez notre support :</strong>
                    ...
                    <li>
                      <strong className="text-foreground">Fournissez les informations suivantes :</strong>
                      <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                    ...
                    <li>
                      <strong className="text-foreground">Délai de traitement :</strong> Votre demande sera étudiée sous 5 à 7 jours ouvrables
                    </li>
                    <li>
                      <strong className="text-foreground">Notification :</strong> Vous recevrez une réponse par email avec notre décision motivée
                    </li>
                    <li>
                      <strong className="text-foreground">Remboursement effectif :</strong> Si accepté, le remboursement sera effectué sous 10 à 15 jours ouvrables
                    </li>
                  </ol>
                </div>
              </section>
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50">
                <h2 className="text-2xl font-bold text-foreground mb-6">Modalités de Remboursement</h2>
                <div className="space-y-4 text-zinc-300">
              ...
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50">
                <h2 className="text-2xl font-bold text-foreground mb-6">Notre Engagement Qualité</h2>
                <div className="space-y-4 text-zinc-300">
                  <p>
                  ...
                  <p className="pt-4">
                    <strong className="text-foreground">Si vous n'êtes pas satisfait,</strong> contactez-nous pour trouver une solution adaptée avant de demander un remboursement.
                  </p>
                </div>
              </section>
              ...
              {/* Modifications */}
              <section className="glass-card p-8 rounded-2xl border border-zinc-800/50">
                <h2 className="text-2xl font-bold text-foreground mb-6">Modifications de la Politique</h2>
                <div className="space-y-4 text-zinc-300">
                  <p>
